import {ACTIONS_TYPE, CurrencyReducersAT} from './actions';
...
export const currencyReducer = (state: CurrencyState = initialState, action: CurrencyReducersAT): CurrencyState => {
    switch (action.type) {
